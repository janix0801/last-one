    ...
    <footer id="contacto" className="border-t border-slate-200 bg-white px-5 py-12 sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1fr_1fr]">
        ...
        <div className="grid gap-4 text-sm text-slate-650 sm:grid-cols-2">
          <a className="footer-link" href="https://instagram.com"><Camera size={18} /> Instagram</a>
...
function ChatbotButton() {
  useEffect(() => {
    ...
    async function loadChat() {
      if (window.__dermaN8nChatLoaded) return;
      window.__dermaN8nChatLoaded = true;
      ...
      createChat({
        webhookUrl: "https://lumeaintelligence.app.n8n.cloud/webhook/98b1ae7b-402e-4c51-82aa-328af9fd4cbd/chat",
        webhookConfig: {
          method: "POST",
          headers: {}
        },
        ...
        defaultLanguage: "es",
        initialMessages: ["¿Cómo puedo ayudarte?"],
        i18n: {
          es: {
    ...
    loadChat().catch(() => {
      window.__dermaN8nChatLoaded = false;
    });
